...
{
    public class GeometryFriendsEvolutionaryAlgorithm<TGenome> : NeatEvolutionAlgorithm<TGenome>
        where TGenome : class, IGenome<TGenome>
    {
        ...
        /// </summary>
        public GeometryFriendsEvolutionaryAlgorithm()
        {
        ...
        /// </summary>
        public GeometryFriendsEvolutionaryAlgorithm(NeatEvolutionAlgorithmParameters eaParams,
        ...
        public void PerformGeneration()
        {
            ...
            // Evaluate genomes.
            _genomeListEvaluator.Evaluate(_genomeList); //--> check exactly what this method does!!!!
